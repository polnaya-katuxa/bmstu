...
struct Mesh {
    ...
    // Variable Set Constructor
    Mesh(std::vector<Vertex>& _Vertices, std::vector<unsigned int>& _Indices, std::vector<Vector3>& _Positions, std::vector<unsigned int> _Indexes)
    {
        Vertices = _Vertices;
        Indices = _Indices;
    ...
    bool LoadFile(std::string Path)
    {
        ...
        while (std::getline(file, curline)) {
            ...
            if (algorithm::firstToken(curline) == "o" || algorithm::firstToken(curline) == "g" || curline[0] == 'g') {
                if (!listening) {
                    ...
                    if (!Indices.empty() && !Vertices.empty()) {
                        // Create Mesh
                        tempMesh = Mesh(Vertices, Indices, Positions, Indexes);
            ...
            if (algorithm::firstToken(curline) == "f") {
                ...
                GenVerticesFromRawOBJ(vVerts, Positions, TCoords, Normals, curline, Indexes);
...
private:
    ...
    void GenVerticesFromRawOBJ(std::vector<Vertex>& oVerts,
        ...
        std::string icurline,
        std::vector<unsigned int>& iIndexes)
    {
        ...
        for (int i = 0; i < int(sface.size()); i++) {
            ...
            case 1: // P
            {
                ...
                iIndexes.push_back(std::stoi(svert[0]));

...
func Describe(label string, wrapped fyne.CanvasObject) *fyne.Container {
...
func Grid() *fyne.Container {
	return defaultProvider.grid()
}
...
func init() {
	...
	fyneWindow = fyneApp.NewWindow("lab_05")
}

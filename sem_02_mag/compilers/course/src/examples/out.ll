...
print_nil:
	...
	%0 = call i32 (i8*, ...) @printf(i8* %nil_fmt)
	ret void
...
print_int:
	...
	%1 = call i32 (i8*, ...) @printf(i8* %int_fmt, i64 %int_val)
	ret void
